...
#define AZMOTOR_UART 12      //Labeled D6
#define AZMOTOR_MICROSTEP 2  // 1/(this value) = the step size for this motor
...
#define ELMOTOR_UART 14     //Labeled D5
#define ELMOTOR_MICROSTEP 8 // 1/(this value) = the step size for this motor
...
#define STEP_DELAY_MIN 150   //Minimum wait time between HI and LO for one step. 
